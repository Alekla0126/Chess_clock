...
class SecondScreen extends StatefulWidget {
  ...
  SecondScreen({required this.game, required this.currentColor, required this.shouldVibrate});
...
class SecondScreenState extends State<SecondScreen>
  ...
  late AnimationController controllerBlack;

  late AnimationController currentController;
    ...
    //whites Turn
      ...
      //just one floatingActionButton
        ...
        return Row(
          ...
          children: <Widget>[
            FloatingActionButton(
              backgroundColor: widget.currentColor['buttons'],
              child: buildPlayStopButton(),
              onPressed: managePlayStopButton,
            )
          ],
